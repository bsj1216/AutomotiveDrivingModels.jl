...
push!(scene, Vehicle(VehicleState(VecSE2(23.0,-DEFAULT_LANE_WIDTH,0.0),roadway,20.0), VehicleDef(),2))
push!(scene, Vehicle(VehicleState(VecSE2(40.0,-DEFAULT_LANE_WIDTH,0.0),roadway,20.0), VehicleDef(),3))
